package com.yidao.court.prelitigation.webapi.generator;
 ...
 */
public class MpInterfaceCenterGenerator {
    /**
     * 包名
     */
//    private static final String PACKAGE_NAME = "com.yidao.court.prelitigationmediation.modular.prelitigation";
    private static final String PACKAGE_NAME = "com.yidao.court.interfacecenter";
     ...
     * 代码注释作者
     */
    private static final String AUTHOR = "zizhan";

    private static final String DRIVER_NAME = "com.mysql.cj.jdbc.Driver";
    private static final String HOST = "47.97.157.169";
    private static final String PORT = "33081";
    /**
     * 数据库信息
     */
    private static final String DATABASE = "yidao_court_prelitigation";
    private static final String USERNAME = "yidao";
    private static final String PASSWORD = "yidao@123";
    private static final String URL = "jdbc:mysql://" + HOST + ":" + PORT + "/" + DATABASE
            + "?characterEncoding=UTF8&serverTimezone=UTC";

    //要生成的表名
    private static String[] tables= {"mq_consumer_record"};
